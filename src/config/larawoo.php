...
return [
    ...
    'options_wp_api_prefix'         => env('LARAWOO_OPT_WPAPI_PREFIX', 'wp-json/wc/'),
    'options_version'               => env('LARAWOO_OPT_VERSION', 'v2'),
    'options_timeout'               => env('LARAWOO_OPT_TIMEOUT', 15),
    'options_follow_redirects'      => env('LARAWOO_OPT_REDIRECTS', true),
